	               			...
	               			<!-- 筛选begin -->
	            				<div class="brandsort_screen" id="search_bar">
	              					<div class="brandsort_sort">
	               						<c:if test="${sessionScope.panduanpice != null }">
					                       <a href="piceorder.htm?panduan=0" class="sort_a" title="点击切换为价格由高到低排列" ><i class="sort_a1">价格</i></a>
					                      </c:if>
					                      <c:if test="${sessionScope.panduanpice == null }">
					                       <a href="piceorder.htm?panduan=1" class="sort_a" title="点击切换为价格由低到高排列" ><i class="sort_a1">价格</i></a>
					                      </c:if>
	               					</div>
