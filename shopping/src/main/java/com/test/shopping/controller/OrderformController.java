...
public class OrderformController {
	...
	/*
	 * @RequestMapping("/order.htm") public String selectByaddorderfindAll(Integer
	 * userid,HttpServletRequest req) { List<Addorder> list =
	 * addorderservice.selectByaddorderfindAll(userid);
	 * req.setAttribute("addorderlist", list); List<Ordergoods> list1 =
	 * ordergoodsservice.selectByfindall(); req.setAttribute("ordergoodslist",
	 * list1); return "order_form"; }
	 */
	
	
	  @RequestMapping("/addordersearch.htm") 
	  public String selectByfindall(String ordernumber,String begintime,String endtime,String delivery,HttpServletRequest req) 
	  { 
