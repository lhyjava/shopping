				...
				<div class="left" style="width: 10%;">
					...
					<div class="left_ul">
						...
						<ul class="ulleft" style="" id="about_goods">
							...
							<li><a href="javascript:void(0);" id="goods_type_op" onclick="openURL('url','http://localhost:8080/admin/goods_type_list.htm','main_workspace','goods_type_op')" class="">类型管理</a></li>
							<li><a href="javascript:void(0);" id="goods_spec_op" onclick="openURL('url','http://localhost:8080/admin/goods_spec_list.htm','main_workspace','goods_spec_op')" class="">规格管理</a></li>
							...
							<li><a href="fileupload" target="main_workspace" class="">文件上传</a></li>
						</ul>
						...
						<ul class="ulleft" style="display:none;" id="about_member">
							...
							<li><a href="javascript:void(0);" class="" id="member_manage_op" onclick="openURL('url','http://localhost:8080/admin/user_list.htm','main_workspace','member_manage_op')">会员管理</a> </li>
