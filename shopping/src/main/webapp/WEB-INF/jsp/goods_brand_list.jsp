    ...
    <div class="brandtable">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="brand_table">
        ...
        <tr>
          ...
          <td><span class="pxnum size5"> <input type="text" name="0" id="0" value="${tmp.sort }" onchange="ajax_update('${tmp.id }','sort',this)" title="可编辑"></span></td>
          <td><span class="pxnum size5"> <input type="text" name="N" id="N" value="${tmp.firstchar }" onchange="ajax_update('${tmp.id }','firstchar',this)" title="可编辑"></span></td>
          <td><span class="pxnum size8"><input name="Nutrilon" type="text" id="Nutrilon" onchange="ajax_update('${tmp.id }','name',this)" value="${tmp.name }" title="可编辑">
          </span></td>
