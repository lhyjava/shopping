...
<form action="goodstypeaddsubmit.htm" method="post">
  <div class="cont">
    ...
    <div class="settab"><span class="tab-one"></span> <span class="tabs"> <a href="http://localhost:8080/admin/goods_type_list.htm">列表</a> | <a href="http://localhost:8080/admin/goods_type_add.htm" class="this">新增</a> </span> <span class="tab-two"></span></div>
    <div class="edit">
      <div class="editul ">
        <ul>
       ...
       <ul class="spec_sports">
         	...
         	<c:forEach items="${requestScope.brandlistforgoodstype }" var="tmp1">
	            <c:if test="${tmp==tmp1.type }">
		            <li> <span class="span1">
			            <input name="brandid" type="checkbox" id="gb_28" value="${tmp1.id }">　
			            ${tmp1.name }
			            </span> 
		            </li> 
	            </c:if> 
